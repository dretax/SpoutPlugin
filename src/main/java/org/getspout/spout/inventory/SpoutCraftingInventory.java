...
public class SpoutCraftingInventory extends SpoutCraftInventory implements CraftingInventory {
	...
	public CraftItemStack[] getContents() {
		...
		net.minecraft.server.v1_5_R1.ItemStack[] mcResultItems = this.result.getContents();
		...
		net.minecraft.server.v1_5_R1.ItemStack[] mcItems = this.inventory.getContents();
	...
	public CraftItemStack getResult() {
		net.minecraft.server.v1_5_R1.ItemStack item = this.result.getItem(0);
	...
	public void setResult(ItemStack item) {
		net.minecraft.server.v1_5_R1.ItemStack[] contents = this.result.getContents();
		if (item == null || item.getTypeId() <= 0) {
			contents[0] = null;
		} else {
