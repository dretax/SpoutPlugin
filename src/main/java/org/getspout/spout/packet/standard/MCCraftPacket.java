...
public class MCCraftPacket implements MCPacket {
	...
	static {
		...
		packets[0] = net.minecraft.server.v1_5_R1.Packet0KeepAlive.class;
		packets[3] = net.minecraft.server.v1_5_R1.Packet3Chat.class;
		packets[17] = net.minecraft.server.v1_5_R1.Packet17EntityLocationAction.class;
		packets[18] = net.minecraft.server.v1_5_R1.Packet18ArmAnimation.class;
		packets[51] = net.minecraft.server.v1_5_R1.Packet51MapChunk.class;
		packets[103] = net.minecraft.server.v1_5_R1.Packet103SetSlot.class;

		packets[256] = net.minecraft.server.v1_5_R1.Packet51MapChunk.class;
	}
