...
public class MCCraftPacket103SetSlot extends MCCraftPacket implements MCPacket103SetSlot {
	...
	private net.minecraft.server.v1_5_R1.ItemStack notchStack;
	...
	public void setItemStack(ItemStack itemStack) {
		...
		if (bukkitStack == null) {
			...
			notchStack = org.bukkit.craftbukkit.v1_5_R1.inventory.CraftItemStack.asNMSCopy(bukkitStack);
		}
		try {
	...
	public void setPacket(Packet packet, int packetId) {
		...
		try {
			...
			slot = Slot.getSlotByRawValues(rawWindow, rawSlot);
			notchStack = (net.minecraft.server.v1_5_R1.ItemStack) itemStackField.get(packet);
			if (notchStack != null) {
				bukkitStack = org.bukkit.craftbukkit.v1_5_R1.inventory.CraftItemStack.asBukkitCopy(notchStack);
			}
		} catch (Exception ex) {
		}
	}
